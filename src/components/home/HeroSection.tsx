...
const HeroSection: React.FC = () => {
  return (
    ...
    >
      ...
      {/* Overlay Gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/20 to-[#F9F9F9]/90"></div>

      <div className="relative z-10 container mx-auto px-6 text-center flex flex-col items-center justify-center h-full pt-20">
        <FadeIn direction="down" className="w-full flex justify-center">
            <img 
                ...
                className="w-full max-w-2xl md:max-w-3xl drop-shadow-2xl mb-16 md:mb-24 filter brightness-110 contrast-125 object-contain"
            />
        </FadeIn>
        ...
        <FadeIn delay={300}>
            <a 
            href="#proyecto"
            className="group relative inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white transition-all duration-200 bg-[#D4AF37] font-pj rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 shadow-xl hover:bg-[#c5a028] hover:-translate-y-1 hover:shadow-2xl"
            >
            ...
            <span className="relative uppercase tracking-widest text-sm md:text-base">Conoce el Proyecto</span>
