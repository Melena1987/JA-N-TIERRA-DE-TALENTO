...
const HomePage: React.FC = () => {
  return (
    <div className="bg-[#F9F9F9]">
      ...
      <section 
        id="home"
        className="relative min-h-[60vh] md:min-h-[80vh] bg-cover bg-center flex items-center justify-center py-20"
        style={{ 
      ...
      >
        ...
        <div className="relative z-10 text-center p-4 flex flex-col items-center w-full">
          <img 
            ...
            className="w-full max-w-3xl px-4 drop-shadow-lg"
          />
          <a 
            href="#proyecto"
            className="mt-12 inline-block bg-[#D4AF37] text-white font-bold py-3 px-10 rounded-full uppercase tracking-wider hover:bg-opacity-90 transition duration-300 shadow-lg text-lg"
          >
            Conoce el Proyecto
          </a>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-[#556B2F] mb-4 uppercase">JAÉN, TIERRA DE TALENTO</h2>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 mb-12">
            ...
            <div className="md:w-2/3">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                En "Jaén, Tierra de Talento", actúa como presentador y moderador, facilitando un diálogo cercano y auténtico entre los ponentes y los estudiantes.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-center gap-8">
               <div className="bg-white p-8 rounded-lg shadow-md flex-1 transform hover:-translate-y-1 transition duration-300">
      ...
      <section id="contacto" className="py-20 bg-[#556B2F] text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-16 mb-12">
            <div className="flex items-center space-x-4 bg-white bg-opacity-10 p-4 rounded-lg hover:bg-opacity-20 transition duration-300">
